...
func InitDB(){
	db, err := gorm.Open(dal.Driver,dal.ConnectionString)
	if err!=nil{
		panic("Some nil in initDB")
	}
	defer db.Close()
	db.SingularTable(true)
	db.AutoMigrate(&models.Client{},&models.CreditAccount{}, &models.Organization{}, &models.Bank{}, &models.Admin{})
}
